...
-- Idosos
INSERT IGNORE INTO idosos (nome, sexo, data_nascimento, estado_civil, responsavel, telefone_responsavel, doencas, observacoes, data_criacao, inativo, falecido, foto_url)
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Segunda', 'cafe',   'Pao integral com queijo e cafe com leite', 220);
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Terca',   'cafe',   'Mingau de aveia com banana',               200);
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Quarta',  'cafe',   'Iogurte natural com granola e mel',        180);
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Quarta',  'almoco', 'Peixe cozido com arroz e brocolis',        380);
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Quarta',  'jantar', 'Caldo de legumes com macarrao',            230);

INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Quinta',  'cafe',   'Tapioca com queijo e suco de laranja',     210);
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Sexta',   'cafe',   'Vitamina de mamao com biscoito integral',  190);
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Sabado',  'cafe',   'Pao de queijo com cafe e fruta',           230);
...
INSERT IGNORE INTO cardapio (dia, tipo, prato, calorias) VALUES ('Domingo', 'cafe',   'Bolo simples com leite e fruta',           240);
